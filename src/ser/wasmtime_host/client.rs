...
impl<S: ::serde::Serializer, T: wasmtime::AsContextMut> wt::exports::serde::serde::serde_serializer::HostSerializer
    for HostsideSerializerProvider<S, T>
{
    fn serialize_bool(&mut self, this: wasmtime::component::ResourceAny, v: bool) -> Result<Result<wasmtime::component::ResourceAny, wasmtime::component::ResourceAny>, wasmtime::Error> {
        loop {}
        // Self::wrap_result(self.serializer.serialize_bool(v))
    }

    fn drop(&mut self, this: wasmtime::component::Resource<wt::exports::serde::serde::serde_serializer::Serializer>) -> Result<(), wasmtime::Error> {
        std::mem::drop(this);
        Ok(())
    }
}
